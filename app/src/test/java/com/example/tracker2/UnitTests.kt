...
class UnitTests {
    ...
    @Test
    fun kmeansTest() {
        genericKMeansTest(kmeansSamples, arrayListOf(2, 1002, 2002, 3002))
    }

    @Test
    fun kmeansTest2() {
        genericKMeansTest(arrayListOf(2, 3, 4, 10, 11, 12, 24, 25, 26, 35, 40, 45), arrayListOf(3, 11, 25, 40))
    }
    ...
    fun resizeTest() {
        ...
        assert(map.toString() == resizeTestMap)
    }
    ...
    fun rotateTest() {
        ...
        assert(filter.similarityTo(emptyMap) == 0.0)
    }
